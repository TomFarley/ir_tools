...
FPATH_RIT_JOB = '/home/tfarley/repos/ir_tools/ir_tools/automation/jobs/intershot_runs/rit_intershot_job.cmd'

def submit_rit_intershot_job():
    try:
        out = subprocess.run(['llsubmit', FPATH_RIT_JOB], stdout=subprocess.PIPE,
...
def rit_intershot():
    review_latest_shots(n_shots=2, camera='rit', copy_recent_shots=True, show=False)
