PRO calibration_error_45, ps=ps
...
if keyword_set(ps) then begin
	atpsopen, filename='calibration_error_45.eps'
	setup_ps
endif else window, 3 
...
xyouts, 0.15,0.905, 'FLIR 045 25 mm (4.1-5.0 um)', /normal, charsize=1.0
